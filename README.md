...
| `DB_SNAPSHOT_PASSPHRASE` | Passphrase used to encrypt/decrypt pre-migration DB snapshots (`DB_SNAPSHOT_PASSPHRASE` secret in GitHub) | Auto-generated by `infra:setup` |
